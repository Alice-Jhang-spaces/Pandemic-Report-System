  ...
  public: {
    Tables: {
      ...
      emergency_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "emergency_reports_ambulance_id_fkey"
          ...
          {
            foreignKeyName: "emergency_reports_hospital_id_fkey"
            columns: ["hospital_id"]
            isOneToOne: false
            referencedRelation: "hospitals"
            referencedColumns: ["id"]
    ...
    Enums: {
      ambulance_status: "available" | "busy" | "offline" | "maintenance"
      app_role:
        | "cdc_admin"
        | "hospital_staff"
        | "ambulance_operator"
